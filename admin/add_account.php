              ...
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                ...
                ?>
                  <form action="phpfunction/add_account.php" method="post">
                    ...
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" name="company_name" onkeyup="this.value  = this.value.toUpperCase();" placeholder="Unit" required>
                      <div class="input-group-append">
                        <div class="input-group-text">
                          <!-- <span class="fas fa-user"></span> -->
                        </div>
                   ...
                   <!--  <div class="input-group mb-3" hidden="">
                    ...
                    <div class="input-group mb-3">
                     ...
                     <!--    <option value="section">Section Account</option> -->
