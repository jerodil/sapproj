      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<h5>Note: List of Beneficiaries was based on the Deduplication Result </h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Dedplication Result Per LGU</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid"><!-- Info boxes -->
        <div class="row">
          <div class="card col-12">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="dupres" class="display" style="width:100%">
                <thead>
                <tr>
...
<script>
 $(document).ready(function ()
        {
            $('#dupres thead th').each(function () {
                var title = $(this).text();
                $(this).html(title+' <input type="text" class="col-search-input" placeholder="Search ' + title + '" />');
            });
            
            var table = $('#dupres').DataTable({
                	"scrollX": true,
            		"pagingType": "numbers",
                "processing": true,
                "serverSide": true,
